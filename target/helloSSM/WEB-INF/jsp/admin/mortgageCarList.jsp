            ...
            <ul class="nav" id="main-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li>
                            <a href="<%=basePath%>admin/mortgageCarList" class="active-menu">按揭车用户</a>
                        </li>
                    </ul>
                </li>
                        ...
                        <div class="card-content">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables- ">
                                    ...
                                    <c:forEach items="${requestScope.mortgageCarList}" var="u">

                                        <tr class="odd gradeX">
                                            <td>${u.mortgageCarId}</td>
                                            <td>${u.userId}</td>
                                            <td>${u.userName1}</td>
                                            <td>${u.userPhone}</td>
                                            <td>${u.moneyEveryMonthCar}</td>
                                            <td>${u.monthOfLoanCar}</td>
