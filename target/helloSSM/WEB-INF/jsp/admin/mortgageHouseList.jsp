    ...
    <nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <li>
                    <a href="#" class="active-menu waves-effect waves-dark"><i class="fa fa-fw fa-file"></i>住房用户分类<span
                            class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li>
                        ...
                        <li>
                            <a href="<%=basePath%>admin/mortgageHouseList" class="active-menu">按揭房用户</a>
                        </li>
                    </ul>
                </li>

                <li>
                    <a href="#" id="car" class="waves-effect waves-dark"><i class="fa fa-bar-chart-o"></i>汽车用户分类<span
                            class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li>
                        ...
                        <div class="card-content">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables- ">
                                    ...
                                    <c:forEach items="${requestScope.mortgageHouseList}" var="u">
                                        <tr class="odd gradeX">
                                            <td>${u.mortgageHouseId}</td>
                                            <td>${u.userId}</td>
                                            <td>${u.userName1}</td>
                                            <td>${u.userPhone}</td>
                                            <%--<td>${u.houseType}</td>--%>
                                            <td>${u.mianLoanPerson}</td>
                                            <td>${u.moneyEveryMonthHouse}</td>
                                            <td>${u.monthOfLoanHouse}</td>
                                            <td>${u.rightOfPeoplenumber}</td>
                                            <td>${u.marketValue}</td>
                                            <td>${u.houseArea}</td>
                                            <td>${u.completeYear}</td>
