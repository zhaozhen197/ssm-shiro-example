    ...
    <nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <li>
                    <a href="#" id="identity" class="active-menu waves-effect waves-dark"><i class="fa fa-sitemap"></i>用户身份分类<span
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li>
                            <a href="<%=basePath%>admin/bussinessOwnerList"  class="active-menu">企业主信息列表</a>
                        </li>
                ...
                <li>
                    <a href="#" class="waves-effect waves-dark"><i class="fa fa-bar-chart-o"></i>汽车用户分类<span
                            class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li>
                        ...
                        <div class="card-content">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables- ">
                                    ...
                                    <c:forEach items="${requestScope.businessOwnerList}" var="u">

                                        <tr class="odd gradeX">
                                            <td>${u.businessOwnerId}</td>
                                            <td>${u.userId}</td>
                                            <td>${u.userName1}</td>
                                            <td>${u.userPhone}</td>
                                            <td>${u.personalExpenses}</td>

                                            <td>${u.companyExpenses}</td>
                                            <td>${u.operationYears}</td>
                                            <td>${u.locationOfCompany}</td>
                                            <td>${u.license}</td>
