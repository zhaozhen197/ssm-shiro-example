                    ...
                    <div class="hdtop clearfix">
                        <span class="hdtopl">
                            <img src="<%=basePath%>static/logo.png" class="logo"> <span id="productTitle"
                                                                                        class="hdtopr">企业贷款</span>
                        </span>

                    </div>
                    <div class="ht1">最高借款额度(元)</div>
                    <div class="ht2">5000000</div>
                    <div class="ht3">
                        <span>手续简单</span>
                        <span>利息低</span>
                        <span>通过率高</span>
                ...
                <div class="prodetai">
                    ...
                    <div class="detail">
                        <div class="pdr clearfix">
                            ...
                            <div class="pdrr">0.39%</div>
                        </div>
                        <div class="pdr clearfix">
                            <div class="pdrl">借款额度</div>
                            <div class="pdrr">￥50000-5000000</div>
                        </div>
                        <div class="pdr clearfix">
                            <div class="pdrl">分期期限</div>
                            <div class="pdrr">可选12、24、36期</div>
                        </div>
                        <div class="pdr clearfix">
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.statusCode == "Success") {
                        ...
                        window.location.href = "<%=basePath%>user/showInputCompany?backurl=" +window.location.href + "&phone=" + phone;
                    }
                }
            });
