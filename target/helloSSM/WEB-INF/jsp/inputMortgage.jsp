...
<div class="content invoice_cont">
    ...
    <div class="forms">
        <form id="form1" method="post" action="<%=basePath%>user/mortgageLoan">
            ...
            <div class="formList clearfix">
                ...
                <div class="form_input float-l">
                    <select name="house" id="houseSel" class="form_sel">
                        ...
                        <option value="mortgageHouse">按揭房(抵押房)</option>
                    </select>
                </div>
            </div>
        ...
        switch (data) {
            case "fullPaymentHouse":
                ...
                $("#houseDiv").append(
                    ...
                    "                                    <div class=\"formTi float-l\" style=\"color:red;\">房产一</div>\n" +
                    "                          </div>\n" +
                    "                <div class=\"formList clearfix\">\n" +
                    "                    <div class=\"formTi float-l\" style='color: #8a8a8a;'>产权人数(个)<span class=\"red\">*</span></div>\n" +
                    "                    <div class=\"form_input float-l\">\n" +
                    "                        <input name=\"fullPaymentHouseList[0].rightOfPeoplenumber\" type=\"number\" style='color: #8a8a8a;' placeholder=\"请输入\"/>\n" +
                    "                    </div>\n" +
                    "                </div>\n" +
                    "\n" +
                    "                <div class=\"formList clearfix\">\n" +
                    ...
                    "                    <div class=\"form_input float-l\">\n" +
                    "                        <input name=\"fullPaymentHouseList[0].marketValue\" type=\"number\" style='color: #8a8a8a;' placeholder=\"请输入\"/>\n" +
                    "                    </div>\n" +
                    "                </div>\n" +
                    "                <div class=\"formList clearfix\">\n" +
                    "                    <div class=\"formTi float-l\" style='color: #8a8a8a;'>房子面积(平米)<span class=\"red\">*</span></div>\n" +
                    "                    <div class=\"form_input float-l\">\n" +
                    "                        <input name=\"fullPaymentHouseList[0].houseArea\" type=\"number\" style='color: #8a8a8a;' placeholder=\"请输入\"/>\n" +
                    "                    </div>\n" +
                    "                </div>\n" +
                    "                <div class=\"formList clearfix\">\n" +
                    "                    <div class=\"formTi float-l\" style='color: #8a8a8a;'>竣工日期(年)<span class=\"red\">*</span></div>\n" +
                    "                    <div class=\"form_input float-l\">\n" +
                    "                        <input name=\"fullPaymentHouseList[0].completeYear\" type=\"number\" style='color: #8a8a8a;' placeholder=\"请输入\"/>\n" +
                    "                    </div>\n" +
                    "                </div>\n" +
                    "\n" +
                    "\n" +
                    "                <div class=\"formListWord clearfix\">\n" +
                    "                    <div class=\"formTi float-l\" style=\"color:red;\">房产二</div>\n" +
                    "                </div>\n" +
                    "                <div class=\"formList clearfix\">\n" +
                    "                    <div class=\"formTi float-l\" style='color: #8a8a8a;'>产权人数(个)<span class=\"red\">*</span></div>\n" +
                    "                    <div class=\"form_input float-l\">\n" +
                    "                        <input name=\"fullPaymentHouseList[1].rightOfPeoplenumber\" type=\"number\" style='color: #8a8a8a;' placeholder=\"请输入\"/>\n" +
                    "                    </div>\n" +
                    "                </div>\n" +
                    "\n" +
                    "                <div class=\"formList clearfix\">\n" +
                    "                    <div class=\"formTi float-l\" style='color: #8a8a8a;'>房子市值(万)<span class=\"red\">*</span></div>\n" +
                    "                    <div class=\"form_input float-l\">\n" +
                    "                        <input name=\"fullPaymentHouseList[1].marketValue\" type=\"number\" style='color: #8a8a8a;' placeholder=\"请输入\"/>\n" +
                    "                    </div>\n" +
                    "                </div>\n" +
                    "                <div class=\"formList clearfix\">\n" +
                    "                    <div class=\"formTi float-l\" style='color: #8a8a8a;'>房子面积(平米)<span class=\"red\">*</span></div>\n" +
                    "                    <div class=\"form_input float-l\">\n" +
                    "                        <input name=\"fullPaymentHouseList[1].houseArea\" type=\"number\" style='color: #8a8a8a;' placeholder=\"请输入\"/>\n" +
                    "                    </div>\n" +
                    "                </div>\n" +
                    "                <div class=\"formList clearfix\">\n" +
                    "                    <div class=\"formTi float-l\" style='color: #8a8a8a;'>竣工日期(年)<span class=\"red\">*</span></div>\n" +
                    "                    <div class=\"form_input float-l\">\n" +
                    "                        <input name=\"fullPaymentHouseList[1].completeYear\" type=\"number\" style='color: #8a8a8a;' placeholder=\"请输入\"/>\n" +
                    "                    </div>\n" +
                    "                </div>"
                );
                break;
            case  "mortgageHouse":
                ...
                $("#houseDiv").append(
                    ...
                    "                    <div class=\"formTi float-l\" style='color: #8a8a8a;'>产权人数(个)<span class=\"red\">*</span></div>\n" +
                    "                    <div class=\"form_input float-l\">\n" +
                    "                        <input name=\"mortgageHouseList[0].rightOfPeoplenumber\" type=\"number\" style='color: #8a8a8a;' placeholder=\"请输入\"/>\n" +
                    "                    </div>\n" +
                    "                </div>\n" +
                    "\n" +
                    "                <div class=\"formList clearfix\">\n" +
                    "                    <div class=\"formTi float-l\" style='color: #8a8a8a;'>未还按揭金额(万)<span class=\"red\">*</span></div>\n" +
                    "                    <div class=\"form_input float-l\">\n" +
                    "                        <input name=\"mortgageHouseList[0].remainingMoney\" type=\"number\" style='color: #8a8a8a;' placeholder=\"请输入\"/>\n" +
                    "                    </div>\n" +
                    "                </div>\n" +
                    "\n" +
                    "                <div class=\"formList clearfix\">\n" +
                    "                    <div class=\"formTi float-l\" style='color: #8a8a8a;'>房子市值<span class=\"red\">*</span></div>\n" +
                    "                    <div class=\"form_input float-l\">\n" +
                    "                        <input name=\"mortgageHouseList[0].marketValue\" type=\"number\" style='color: #8a8a8a;' placeholder=\"请输入\"/>\n" +
                    "                    </div>\n" +
                    "                </div>\n" +
                    "\n" +
                    "                <div class=\"formList clearfix\">\n" +
                    "                    <div class=\"formTi float-l\" style='color: #8a8a8a;'>房子面积(平米)<span class=\"red\">*</span></div>\n" +
                    "                    <div class=\"form_input float-l\">\n" +
                    "                        <input name=\"mortgageHouseList[0].houseArea\" type=\"number\" style='color: #8a8a8a;' placeholder=\"请输入\"/>\n" +
                    "                    </div>\n" +
                    "                </div>\n" +
                    "                <div class=\"formList clearfix\">\n" +
                    "                    <div class=\"formTi float-l\" style='color: #8a8a8a;'>竣工日期(年)<span class=\"red\">*</span></div>\n" +
                    "                    <div class=\"form_input float-l\">\n" +
                    "                        <input name=\"mortgageHouseList[0].completeYear\" type=\"number\" style='color: #8a8a8a;' placeholder=\"请输入\"/>\n" +
                    "                    </div>\n" +
                    "                </div>\n" +
                    "\n" +
                    "\n" +
                    ...
                    "                    <div class=\"formTi float-l\" style='color: #8a8a8a;'>产权人数(个)<span class=\"red\">*</span></div>\n" +
                    "                    <div class=\"form_input float-l\">\n" +
                    "                        <input name=\"mortgageHouseList[1].rightOfPeoplenumber\" type=\"number\" style='color: #8a8a8a;' placeholder=\"请输入\"/>\n" +
                    "                    </div>\n" +
                    "                </div>\n" +
                    "\n" +
                    "                <div class=\"formList clearfix\">\n" +
                    "                    <div class=\"formTi float-l\" style='color: #8a8a8a;'>未还按揭金额(万)<span class=\"red\">*</span></div>\n" +
                    "                    <div class=\"form_input float-l\">\n" +
                    "                        <input name=\"mortgageHouseList[1].remainingMoney\" type=\"number\" style='color: #8a8a8a;' placeholder=\"请输入\"/>\n" +
                    "                    </div>\n" +
                    "                </div>\n" +
                    "\n" +
                    "                <div class=\"formList clearfix\">\n" +
                    "                    <div class=\"formTi float-l\" style='color: #8a8a8a;'>房子市值<span class=\"red\">*</span></div>\n" +
                    "                    <div class=\"form_input float-l\">\n" +
                    "                        <input name=\"mortgageHouseList[1].marketValue\" type=\"number\" style='color: #8a8a8a;' placeholder=\"请输入\"/>\n" +
                    "                    </div>\n" +
                    "                </div>\n" +
                    "\n" +
                    "                <div class=\"formList clearfix\">\n" +
                    "                    <div class=\"formTi float-l\" style='color: #8a8a8a;'>房子面积(平米)<span class=\"red\">*</span></div>\n" +
                    "                    <div class=\"form_input float-l\">\n" +
                    "                        <input name=\"mortgageHouseList[1].houseArea\" type=\"number\" style='color: #8a8a8a;' placeholder=\"请输入\"/>\n" +
                    "                    </div>\n" +
                    "                </div>\n" +
                    "                <div class=\"formList clearfix\">\n" +
                    "                    <div class=\"formTi float-l\" style='color: #8a8a8a;'>竣工日期(年)<span class=\"red\">*</span></div>\n" +
                    "                    <div class=\"form_input float-l\">\n" +
                    "                        <input name=\"mortgageHouseList[1].completeYear\" type=\"number\" style='color: #8a8a8a;' placeholder=\"请输入\"/>\n" +
                    "                    </div>\n" +
                    "                </div>"
                );
                break;
        ...
        switch (data) {
            case "1":
                ...
                $("#insuranceDiv").append(
                    ...
                    "                    <div class=\"form_input float-l\">\n" +
                    "                        <select style='color: #8a8a8a;' name=\"fullPaymentHouseList[0].insuranceOrNot\" class=\"form_sel\">\n" +
                    ...
                    "                    <div class=\"form_input float-l\">\n" +
                    "                        <select id=\"companyOfInsurance\" style='color: #8a8a8a;' name=\"fullPaymentHouseList[0].companyOfInsurance\" class=\"form_sel\">\n" +
                    "                            <option value=\"0\">请选择</option>\n" +
                    ...
                    "                    <div class=\"form_input float-l\">\n" +
                    "                        <input style='color: #8a8a8a;' name=\"fullPaymentHouseList[0].moneyOfYearInsurance\" type=\"number\" placeholder=\"请输入\"/>\n" +
                    "                    </div>\n" +
                    "                </div>\n" +
                    "                <div class=\"formList clearfix\">\n" +
                    "                    <div class=\"formTi float-l\" style='color: #8a8a8a;'>缴费年限(年)<span class=\"red\">*</span></div>\n" +
                    "                    <div class=\"form_input float-l\">\n" +
                    "                        <input style='color: #8a8a8a;' name=\"fullPaymentHouseList[0].yearsOfInsurance\" type=\"number\" placeholder=\"请输入\"/>\n" +
                    "                    </div>\n" +
                    "                </div>\n" +
                    "\n" +
                    "\n" +
                    ...
                    "                    <div class=\"formTi float-l\" style='color: #8a8a8a;'>是否投保人<span class=\"red\">*</span></div>\n" +
                    "                    <div class=\"form_input float-l\">\n" +
                    "                        <select name=\"fullPaymentHouseList[1].insuranceOrNot\" style='color: #8a8a8a;' class=\"form_sel\">\n" +
                    "                            <option value=\"0\">否</option>\n" +
                    "                            <option value=\"1\">是</option>\n" +
                    "                        </select>\n" +
                    "                    </div>\n" +
                    ...
                    "                    <div class=\"formTi float-l\" style='color: #8a8a8a;'>保单公司<span class=\"red\">*</span></div>\n" +
                    "                    <div class=\"form_input float-l\">\n" +
                    "                        <select  style='color: #8a8a8a;' name=\"fullPaymentHouseList[1].companyOfInsurance\" class=\"form_sel\">\n" +
                    ...
                    "                    <div class=\"formTi float-l\" style='color: #8a8a8a;'>年交金额(元)<span class=\"red\">*</span></div>\n" +
                    "                    <div class=\"form_input float-l\">\n" +
                    "                        <input name=\"fullPaymentHouseList[1].moneyOfYearInsurance\" style='color: #8a8a8a;'  type=\"number\" placeholder=\"请输入\"/>\n" +
                    "                    </div>\n" +
                    "                </div>\n" +
                    "                <div class=\"formList clearfix\">\n" +
                    "                    <div class=\"formTi float-l\" style='color: #8a8a8a;'>缴费年限(年)<span class=\"red\">*</span></div>\n" +
                    "                    <div class=\"form_input float-l\">\n" +
                    "                        <input name=\"fullPaymentHouseList[1].yearsOfInsurance\" style='color: #8a8a8a;' type=\"number\" placeholder=\"请输入\"/>\n" +
                    "                    </div>\n" +
                    "                </div>\n" +
                    "\n" +
                    "\n" +
                    ...
                    "                    <div class=\"formTi float-l\" style='color: #8a8a8a;'>是否投保人<span class=\"red\">*</span></div>\n" +
                    "                    <div class=\"form_input float-l\">\n" +
                    "                        <select name=\"fullPaymentHouseList[2].insuranceOrNot\" style='color: #8a8a8a;' class=\"form_sel\">\n" +
                    "                            <option value=\"0\">否</option>\n" +
                    "                            <option value=\"1\">是</option>\n" +
                    "                        </select>\n" +
                    "                    </div>\n" +
                    ...
                    "                    <div class=\"formTi float-l\" style='color: #8a8a8a;'>保单公司<span class=\"red\">*</span></div>\n" +
                    "                    <div class=\"form_input float-l\">\n" +
                    "                        <select  style='color: #8a8a8a;' name=\"fullPaymentHouseList[2].companyOfInsurance\" class=\"form_sel\">\n" +
                    "                            <option value=\"companyOfInsurance0\">请选择</option>\n" +
                    "                            <option value=\"pingAnRenShou\">平安人寿</option>\n" +
                    "                            <option value=\"zhongGuoRenShou\">中国人寿</option>\n" +
                    "                            <option value=\"renMinBaoXian\">人民保险</option>\n" +
                    ...
                    "                    <div class=\"form_input float-l\">\n" +
                    "                        <input style='color: #8a8a8a;' name=\"fullPaymentHouseList[2].moneyOfYearInsurance\" type=\"number\" placeholder=\"请输入\"/>\n" +
                    "                    </div>\n" +
                    "                </div>\n" +
                    "                <div class=\"formList clearfix\">\n" +
                    "                    <div style='color: #8a8a8a;' class=\"formTi float-l\">缴费年限(年)<span class=\"red\">*</span></div>\n" +
                    "                    <div  class=\"form_input float-l\">\n" +
                    "                        <input  style='color: #8a8a8a;'  name=\"fullPaymentHouseList[2].yearsOfInsurance\" type=\"number\" placeholder=\"请输入\"/>\n" +
                    "                    </div>\n" +
                    "                </div>"
                );
                break;
