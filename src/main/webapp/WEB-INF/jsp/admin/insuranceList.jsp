    ...
    <nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <li>
                    <a href="<%=basePath%>admin/insuranceList" class="active-menu waves-effect waves-dark"><i
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables- ">
                                    ...
                                    <c:forEach items="${requestScope.fullPaymentHouseList}" var="u">
                                        <tr class="odd gradeX">
                                            ...
                                            <td>${u.userName1}</td>
                                            <td>${u.userPhone}</td>
                                            <td>${u.insuranceOrNot}</td>
                                            <td>${u.companyOfInsurance}</td>
                                            <td>${u.moneyOfYearInsurance}</td>
                                            <td>${u.yearsOfInsurance}</td>
